    ...
    <div className="relative w-full h-[85vh] min-h-[600px] flex items-end">
      ...
      <div className="relative z-20 w-full px-4 sm:px-8 max-w-[1400px] mx-auto pb-32">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <button 
            onClick={handlePlay}
            className="nav-item flex items-center px-8 py-3.5 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white font-bold rounded-xl transition-all hover:scale-105 border border-white/20 shadow-[0_0_30px_rgba(255,255,255,0.15)] focus:ring-4 focus:ring-white/30 outline-none"
          >
          ...
          <button 
             ...
             className="nav-item flex items-center px-8 py-3.5 bg-black/40 hover:bg-black/60 backdrop-blur-md text-zinc-100 font-bold rounded-xl transition-all hover:scale-105 border border-white/10 shadow-lg focus:ring-4 focus:ring-white/20 outline-none">
