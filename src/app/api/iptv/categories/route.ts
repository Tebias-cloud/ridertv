...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const proxyUrl = `${cleanPortalUrl}/player_api.php?username=${username}&password=${password}&action=get_live_categories`
    ...
    console.error("API Categories Proxy Error:", error.message)
    return NextResponse.json(
